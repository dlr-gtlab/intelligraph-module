...
- The style of comments can be customized using a dedicated dialog that can be opened using the context menu of comments. This dialog allows to change the background color and text color, frame visibility and the text alignment. - #326
