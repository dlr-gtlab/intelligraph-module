...
#ifndef GT_INTELLI_GRAPHEXECDATAMODEL_H
#define GT_INTELLI_GRAPHEXECDATAMODEL_H
...
using GraphExecDataModel = QHash<NodeUuid, DataItem>;

} // namespace data_model

using data_model::GraphExecDataModel;

} // namespace intelli

#endif // GT_INTELLI_GRAPHEXECDATAMODEL_H
