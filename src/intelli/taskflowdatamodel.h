...
#ifndef GT_INTELLI_TASKFLOWDATAMODEL_H
#define GT_INTELLI_TASKFLOWDATAMODEL_H
...
class GT_INTELLI_EXPORT TaskFlowDataModel : public NodeDataInterface
{
    Q_OBJECT

public:

    TaskFlowDataModel(Graph& graph);
    ~TaskFlowDataModel() override;
...
#endif // GT_INTELLI_TASKFLOWDATAMODEL_H
